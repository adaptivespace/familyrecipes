...
- [ ] **Markdown Service (`src/lib/recipes.ts`)**
...
- [ ] **"Cooklang-Lite" Parser (`src/lib/parser.ts`)**
...
- [ ] **Importer Engine (`src/lib/importer.ts`)**
...
- [ ] **Recipe Detail Page (`src/app/recipe/[slug]/page.tsx`)**
  - **Header:**
